...
if ($dados['AceitaEntrevista'] == 'Nao Atende') {    
    $query = "update tabela_pos_bd set STATUSTRATATIVA = 'Nao Atende', NUN_TENT_CONTATO = '" . $dados['numeroTentativaContato'] . "', ACEITA_ENTREVISTA = '" . $dados['AceitaEntrevista'] . "', TITULAR_LINHA = '" . $dados['titularLinha'] . "',NOME_ENTREVISTADO = '" . $dados['nomeEntrevistado'] . "',
    ...
    $query = "update tabela_pos_bd set STATUSTRATATIVA = 'Retornar', ACEITA_ENTREVISTA = '" . $dados['AceitaEntrevista'] . "', TITULAR_LINHA = '" . $dados['titularLinha'] . "',NOME_ENTREVISTADO = '" . $dados['nomeEntrevistado'] . "',
    UTILIZOU_WIFI = '" . $dados['utilizouWifi'] . "',UTILIZOU_WIFI_MAIOR_FREQ = '" . $dados['utilizouWifiMaiorFreq'] . "',PODERIA_TESTE_WIFI_MAIOR_FREQ = '" . $dados['poderiaTesteWifiMaiorFreq'] . "', PROBLEMAS_TRAVAMENTO_QUEDAS = '" . $dados['problemasTravamentoQuedas'] . "',
    OBSERVACAO = '" . $dados['observacao'] . "',DATA_AGENDADO = '" . $dados['dataAgendado'] . "', USUARIO = '".$_SESSION['nome']."' Where SS = '" . $dados['ss'] . "'";
} else {
    $query = "update tabela_pos_bd set STATUSTRATATIVA = 'Tratado', ACEITA_ENTREVISTA = '" . $dados['AceitaEntrevista'] . "', TITULAR_LINHA = '" . $dados['titularLinha'] . "',NOME_ENTREVISTADO = '" . $dados['nomeEntrevistado'] . "',
    UTILIZOU_WIFI = '" . $dados['utilizouWifi'] . "',UTILIZOU_WIFI_MAIOR_FREQ = '" . $dados['utilizouWifiMaiorFreq'] . "',PODERIA_TESTE_WIFI_MAIOR_FREQ = '" . $dados['poderiaTesteWifiMaiorFreq'] . "', PROBLEMAS_TRAVAMENTO_QUEDAS = '" . $dados['problemasTravamentoQuedas'] . "',
    OBSERVACAO = '" . $dados['observacao'] . "', DATA_AGENDADO = '" . $dados['dataAgendado'] . "',USUARIO = '".$_SESSION['nome']."' Where SS = '" . $dados['ss'] . "'";
