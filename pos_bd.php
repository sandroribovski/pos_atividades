...
<body>
            ...
            <div class="header clearfix">
                <nav style="margin-top:3px">
                    <ul class="nav nav-pills pull-right">
                        <li role="presentation" class="active"><a href="http://10.238.176.70/Pos/pos_bd.php">Pos Defeito</a></li>
                        <li role="presentation"><a href="http://10.238.176.70/Pos/pos.php">Pos Instalações</a></li>
                        <?php if($status == '0'){ ?>
        ...
        <table id="tabela" class="table table-striped,table table-bordered, text-align:center">
            <thead>
                <tr style="font-size:12px;color:#e6f9ff;background:#165e6b;text-align:center">
                    ...
                    <th style='text-align:center'><a style="color:#e6f9ff"
                            href="exportar_bd.php?cluster=<?php echo $cluster; ?>"><span
                                style="color:#e6f9ff; font-size: 15px" class="glyphicon glyphicon-cloud-download"
            ...
            <tbody>
                <?php
                    if ($status == '0') {
                        $query = "Select * from  tabela_pos_bd order by DATAEXECUCAO DESC OFFSET 1 ROWS FETCH NEXT 25 ROWS ONLY";
                     }else {
                         $sqlCount = "SELECT * FROM tabela_pos_bd WHERE CLUSTER_ = '$cluster' and OBSERVACAO = '$usuario'";
                         $params = array();
                         $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
                         $stmt = sqlsrv_query( $conn, $sqlCount , $params, $options );
                         
                         if (sqlsrv_num_rows($stmt) != 0 ) {
                                $query = "SELECT * FROM tabela_pos_bd WHERE CLUSTER_ = '$cluster' and OBSERVACAO = '$usuario'";
                            } else {
                                $query = "Select * from  tabela_pos_bd where CLUSTER_ = '$cluster' and STATUSTRATATIVA != 'Tratado' order by DATAEXECUCAO DESC OFFSET $inicio ROWS FETCH NEXT $quantidade_pg ROWS ONLY";
                        }
                         
                     }
                    $sql = sqlsrv_query($conn, $query);

                    $resultadoEvento = sqlsrv_query($conn,"Select * from  tabela_pos_bd where CLUSTER_ = '$cluster'");
                    //verifica a quantidade de eventos 
                    $params = array();
                    $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
                    $stmt = sqlsrv_query( $conn, "Select * from  tabela_pos_bd where CLUSTER_ = '$cluster'" , $params, $options );
                ...
                <tr style="font-size:11px;text-align:center">
                    ...
                    <th style='text-align:center'><button type="button" class="btn btn-success btn-sm"
                            data-toggle="tooltip" data-placement="top"
                            title="Em Atendimento com: <?php echo $obj->USUARIO; ?>"><span
                ...
                <div class="modal fade" id="<?php echo $obj->SS; ?>" data-backdrop="static" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document" style="width:900px">
                        ...
                        $(document).ready(function() {
                            $('#AceitaEntrevistaNaoAtende<?php echo $obj->INSTANCIA; ?>').change(
                                function() {
                        ...
                        $(document).ready(function() {
                            ...
                            $('#titularLinha<?php echo $obj->INSTANCIA; ?>').change(function() {
                                if ($('#titularLinha<?php echo $obj->INSTANCIA; ?>').val() ==
                                    'nao') {
                        ...
                        $(document).ready(function() {
                            ...
                            $('#naoPodeTesteWifiMaiorFreqNao<?php echo $obj->INSTANCIA; ?>').change(
                                function() {
                        ...
                        $(document).ready(function() {
                            $('#exibir7<?php echo $obj->INSTANCIA; ?>').hide();
                            $('#poderiaTesteWifiMaiorFreqSim<?php echo $obj->INSTANCIA; ?>').change(
                                function() {
                        ...
                        $(document).ready(function() {
                            ...
                            $('#edentificouTravamentoQuedasSim<?php echo $obj->INSTANCIA; ?>').change(
                                function() {
                                    if ($(
                                            '#edentificouTravamentoQuedasSim<?php echo $obj->INSTANCIA; ?>')
                                        .val() == 'sim') {
                        ...
                        $(document).ready(function() {
                            ...
                            $('#edentificouTravamentoQuedasNao<?php echo $obj->INSTANCIA; ?>').change(
                                function() {
                                    if ($(
                                            '#edentificouTravamentoQuedasNao<?php echo $obj->INSTANCIA; ?>')
                                        .val() == 'nao') {
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input style="font-weight:bold;background-color: rgb(235, 235, 224) !important;" name="cliente" class="form-control" value="<?php echo $obj->CUSTOMER_NAME; ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small style="font-size:9px" class="help-block text-info"><em>Este
                                                    numero
                                ...
                                <form action="dados_bd.php" method="post">
                                                    ...
                                                    <div class="form-control">
                                                        <label class="radio-inline">
                                                            <input
                                                                ...
                                                                type="radio" name="AceitaEntrevista" value="sim">
                                                            Sim
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input
                                                                id="AceitaEntrevistaNao<?php echo $obj->INSTANCIA; ?>"
                                                                type="radio" name="AceitaEntrevista" value="nao">
                                                            Não
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input
                                    ...
                                    <div id="exibir2<?php echo $obj->INSTANCIA; ?>" class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="input-group input-group-sm">
                                                    <span class="input-group-addon"><b>O Sr(a) já utilizou a banda
                                                            larga
                                                            via WIFI?</b></span>
                                                    <div class="form-control">
                                                        <label class="radio-inline">
                                    ...
                                    <div id="exibir4<?php echo $obj->INSTANCIA; ?>" class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="input-group input-group-sm">
                                                    <span class="input-group-addon"><b>O Sr(a) Testou nos ambientes
                                                            que
                                    ...
                                    <div id="exibir5<?php echo $obj->INSTANCIA; ?>" class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="input-group input-group-sm">
                                                    <span class="input-group-addon"><b>Sr(a) poderia realizar um
                                                            teste
                                    ...
                                    <div id="exibir7<?php echo $obj->INSTANCIA; ?>" class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="input-group input-group-sm">
                                                    <span class="input-group-addon"><b>O Sr(a) Observou algum
                                                            problema
                                                            de travamento, quedas ou problemas com a
                                                            Linha?</b></span>
                                                    <div class="form-control">
                                                        <label class="radio-inline">
                                                            <input
    ...
    <nav aria-label="Page navigation example" class="text-center">
        <ul class="pagination">
            <li class="page-item">
                ...
                <a href="pos_bd.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
            ...
            <li><a href="pos_bd.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a></li>
            <?php } ?>
            <li>
                <?php
					if($pagina_posterior <= $num_pagina){ ?>
                <a href="pos_bd.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
    ...
    function chamarSS(ssId) {
        if (ssId) {
            console.log("SS: " + ssId);
            var url = 'testepos_bd.php?ss=' + ssId;
    ...
    function limparSS(ssId) {
        ...
        if (ssId) {
            ...
            var url = 'testepos_bd.php?sslimpar=' + ssId;
            $.get(url, function(dataReturn) {
                $('#resp-emergencia').html(dataReturn);
            });
        }
